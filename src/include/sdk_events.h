...
{
public:
    CodeBlocksEvent(wxEventType commandType = wxEVT_NULL, int id = 0, cbProject *project = nullptr,
                    EditorBase *editor = nullptr, cbPlugin *plugin = nullptr,
...
{
public:
    CodeBlocksLayoutEvent(wxEventType commandType = wxEVT_NULL,
                          const wxString &layout_name = wxEmptyString)
      : wxEvent(wxID_ANY, commandType), layout(layout_name)
    {
    }
    CodeBlocksLayoutEvent(const CodeBlocksLayoutEvent &rhs) : wxEvent(rhs), layout(rhs.layout) {}
 ...
 * By adding a wxWindow*, the ownership is not touched and you should delete the window after
 * calling cbEVT_REMOVE_LOG_WINDOW for it.
 */
class EVTIMPORT CodeBlocksLogEvent : public wxEvent
{
public:
    CodeBlocksLogEvent(wxEventType commandType = wxEVT_NULL, Logger *logger = nullptr,
                       const wxString &title = wxEmptyString, wxBitmap *icon = nullptr);
    CodeBlocksLogEvent(wxEventType commandType, wxWindow *window,
                       const wxString &title = wxEmptyString, wxBitmap *icon = nullptr);
    CodeBlocksLogEvent(wxEventType commandType, int logIndex, const wxString &title = wxEmptyString,
...
public:
    ...
    CodeBlocksThreadEvent(const CodeBlocksThreadEvent &event) : wxCommandEvent(event)
    {
    ...
    virtual wxEvent *Clone() const { return new CodeBlocksThreadEvent(*this); }
...
#define CodeBlocksThreadEventHandler(func) \
    (wxObjectEventFunction)(wxEventFunction) wxStaticCastEvent(CodeblocksThreadEventFunction, &func)

#define EVT_CODEBLOCKS_THREAD(id, fn)                                                             \
    DECLARE_EVENT_TABLE_ENTRY(                                                                    \
        wxEVT_COMMAND_MENU_SELECTED, id, wxID_ANY,                                                \
        (wxObjectEventFunction)(wxEventFunction)(CodeblocksThreadEventFunction)wxStaticCastEvent( \
            ThreadEventFunction, &fn),                                                            \
        (wxObject *)NULL),
...
#define EVT_APP_STARTUP_DONE(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(          \
        cbEVT_APP_STARTUP_DONE, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_APP_START_SHUTDOWN;
#define EVT_APP_START_SHUTDOWN(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(            \
        cbEVT_APP_START_SHUTDOWN, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_APP_ACTIVATED;
#define EVT_APP_ACTIVATED(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(       \
        cbEVT_APP_ACTIVATED, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_APP_DEACTIVATED;
#define EVT_APP_DEACTIVATED(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(         \
        cbEVT_APP_DEACTIVATED, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_APP_CMDLINE;
#define EVT_APP_CMDLINE(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(     \
        cbEVT_APP_CMDLINE, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),

// plugin events
extern EVTIMPORT const wxEventType cbEVT_PLUGIN_ATTACHED;
#define EVT_PLUGIN_ATTACHED(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(         \
        cbEVT_PLUGIN_ATTACHED, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_PLUGIN_RELEASED;
#define EVT_PLUGIN_RELEASED(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(         \
        cbEVT_PLUGIN_RELEASED, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_PLUGIN_INSTALLED;
#define EVT_PLUGIN_INSTALLED(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(          \
        cbEVT_PLUGIN_INSTALLED, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_PLUGIN_UNINSTALLED;
#define EVT_PLUGIN_UNINSTALLED(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(            \
        cbEVT_PLUGIN_UNINSTALLED, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_PLUGIN_LOADING_COMPLETE;
#define EVT_PLUGIN_LOADING_COMPLETE(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(                 \
        cbEVT_PLUGIN_LOADING_COMPLETE, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),

// editor events
extern EVTIMPORT const wxEventType cbEVT_EDITOR_CLOSE;
#define EVT_EDITOR_CLOSE(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(      \
        cbEVT_EDITOR_CLOSE, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_EDITOR_OPEN;
#define EVT_EDITOR_OPEN(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(     \
        cbEVT_EDITOR_OPEN, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_EDITOR_SWITCHED;
#define EVT_EDITOR_SWITCHED(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(         \
        cbEVT_EDITOR_SWITCHED, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_EDITOR_ACTIVATED;
#define EVT_EDITOR_ACTIVATED(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(          \
        cbEVT_EDITOR_ACTIVATED, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_EDITOR_DEACTIVATED;
#define EVT_EDITOR_DEACTIVATED(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(            \
        cbEVT_EDITOR_DEACTIVATED, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_EDITOR_BEFORE_SAVE;
#define EVT_EDITOR_BEFORE_SAVE(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(            \
        cbEVT_EDITOR_BEFORE_SAVE, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_EDITOR_SAVE;
#define EVT_EDITOR_SAVE(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(     \
        cbEVT_EDITOR_SAVE, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_EDITOR_MODIFIED;
#define EVT_EDITOR_MODIFIED(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(         \
        cbEVT_EDITOR_MODIFIED, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_EDITOR_TOOLTIP;
#define EVT_EDITOR_TOOLTIP(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(        \
        cbEVT_EDITOR_TOOLTIP, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_EDITOR_TOOLTIP_CANCEL;
#define EVT_EDITOR_TOOLTIP_CANCEL(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(               \
        cbEVT_EDITOR_TOOLTIP_CANCEL, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_EDITOR_SPLIT;
#define EVT_EDITOR_SPLIT(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(      \
        cbEVT_EDITOR_SPLIT, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_EDITOR_UNSPLIT;
#define EVT_EDITOR_UNSPLIT(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(        \
        cbEVT_EDITOR_UNSPLIT, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_EDITOR_UPDATE_UI;
#define EVT_EDITOR_UPDATE_UI(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(          \
        cbEVT_EDITOR_UPDATE_UI, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),

extern EVTIMPORT const wxEventType cbEVT_EDITOR_CC_DONE;
#define EVT_EDITOR_CC_DONE(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(        \
        cbEVT_EDITOR_CC_DONE, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),

// project events
extern EVTIMPORT const wxEventType cbEVT_PROJECT_NEW;
#define EVT_PROJECT_NEW(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(     \
        cbEVT_PROJECT_NEW, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_PROJECT_CLOSE;
#define EVT_PROJECT_CLOSE(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(       \
        cbEVT_PROJECT_CLOSE, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_PROJECT_OPEN;
#define EVT_PROJECT_OPEN(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(      \
        cbEVT_PROJECT_OPEN, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_PROJECT_SAVE;
#define EVT_PROJECT_SAVE(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(      \
        cbEVT_PROJECT_SAVE, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_PROJECT_ACTIVATE;
#define EVT_PROJECT_ACTIVATE(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(          \
        cbEVT_PROJECT_ACTIVATE, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_PROJECT_BEGIN_ADD_FILES;
#define EVT_PROJECT_BEGIN_ADD_FILES(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(                 \
        cbEVT_PROJECT_BEGIN_ADD_FILES, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_PROJECT_END_ADD_FILES;
#define EVT_PROJECT_END_ADD_FILES(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(               \
        cbEVT_PROJECT_END_ADD_FILES, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_PROJECT_BEGIN_REMOVE_FILES;
#define EVT_PROJECT_BEGIN_REMOVE_FILES(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(                    \
        cbEVT_PROJECT_BEGIN_REMOVE_FILES, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_PROJECT_END_REMOVE_FILES;
#define EVT_PROJECT_END_REMOVE_FILES(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(                  \
        cbEVT_PROJECT_END_REMOVE_FILES, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_PROJECT_FILE_ADDED;
#define EVT_PROJECT_FILE_ADDED(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(            \
        cbEVT_PROJECT_FILE_ADDED, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_PROJECT_FILE_REMOVED;
#define EVT_PROJECT_FILE_REMOVED(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(              \
        cbEVT_PROJECT_FILE_REMOVED, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_PROJECT_FILE_CHANGED;
#define EVT_PROJECT_FILE_CHANGED(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(              \
        cbEVT_PROJECT_FILE_CHANGED, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_PROJECT_POPUP_MENU;
#define EVT_PROJECT_POPUP_MENU(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(            \
        cbEVT_PROJECT_POPUP_MENU, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_PROJECT_TARGETS_MODIFIED;
#define EVT_PROJECT_TARGETS_MODIFIED(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(                  \
        cbEVT_PROJECT_TARGETS_MODIFIED, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_PROJECT_RENAMED;
#define EVT_PROJECT_RENAMED(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(         \
        cbEVT_PROJECT_RENAMED, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_PROJECT_OPTIONS_CHANGED;
#define EVT_PROJECT_OPTIONS_CHANGED(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(                 \
        cbEVT_PROJECT_OPTIONS_CHANGED, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_WORKSPACE_CHANGED;
#define EVT_WORKSPACE_CHANGED(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(           \
        cbEVT_WORKSPACE_CHANGED, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_WORKSPACE_LOADING_COMPLETE;
#define EVT_WORKSPACE_LOADING_COMPLETE(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(                    \
        cbEVT_WORKSPACE_LOADING_COMPLETE, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_WORKSPACE_CLOSING_BEGIN;
#define EVT_WORKSPACE_CLOSING_BEGIN(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(                 \
        cbEVT_WORKSPACE_CLOSING_BEGIN, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_WORKSPACE_CLOSING_COMPLETE;
#define EVT_WORKSPACE_CLOSING_COMPLETE(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(                    \
        cbEVT_WORKSPACE_CLOSING_COMPLETE, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),

// build targets events
extern EVTIMPORT const wxEventType cbEVT_BUILDTARGET_ADDED;
#define EVT_BUILDTARGET_ADDED(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(           \
        cbEVT_BUILDTARGET_ADDED, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_BUILDTARGET_REMOVED;
#define EVT_BUILDTARGET_REMOVED(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(             \
        cbEVT_BUILDTARGET_REMOVED, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_BUILDTARGET_RENAMED;
#define EVT_BUILDTARGET_RENAMED(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(             \
        cbEVT_BUILDTARGET_RENAMED, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_BUILDTARGET_SELECTED;
#define EVT_BUILDTARGET_SELECTED(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(              \
        cbEVT_BUILDTARGET_SELECTED, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),

// pipedprocess events
extern EVTIMPORT const wxEventType cbEVT_PIPEDPROCESS_STDOUT;
#define EVT_PIPEDPROCESS_STDOUT(id, fn)                                                            \
    DECLARE_EVENT_TABLE_ENTRY(cbEVT_PIPEDPROCESS_STDOUT, id, wxID_ANY,                             \
                              (wxObjectEventFunction)(wxEventFunction)(wxCommandEventFunction)&fn, \
                              (wxObject *)NULL),
#define EVT_PIPEDPROCESS_STDOUT_RANGE(id, id1, fn)                                                 \
    DECLARE_EVENT_TABLE_ENTRY(cbEVT_PIPEDPROCESS_STDOUT, id, id1,                                  \
                              (wxObjectEventFunction)(wxEventFunction)(wxCommandEventFunction)&fn, \
                              (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_PIPEDPROCESS_STDERR;
#define EVT_PIPEDPROCESS_STDERR(id, fn)                                                            \
    DECLARE_EVENT_TABLE_ENTRY(cbEVT_PIPEDPROCESS_STDERR, id, wxID_ANY,                             \
                              (wxObjectEventFunction)(wxEventFunction)(wxCommandEventFunction)&fn, \
                              (wxObject *)NULL),
#define EVT_PIPEDPROCESS_STDERR_RANGE(id, id1, fn)                                                 \
    DECLARE_EVENT_TABLE_ENTRY(cbEVT_PIPEDPROCESS_STDERR, id, id1,                                  \
                              (wxObjectEventFunction)(wxEventFunction)(wxCommandEventFunction)&fn, \
                              (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_PIPEDPROCESS_TERMINATED;
#define EVT_PIPEDPROCESS_TERMINATED(id, fn)                                                     \
    DECLARE_EVENT_TABLE_ENTRY(cbEVT_PIPEDPROCESS_TERMINATED, id, wxID_ANY,                      \
                              (wxObjectEventFunction)(wxEventFunction)(wxCommandEventFunction)( \
                                  wxNotifyEventFunction)(CodeBlocksEventFunction)&fn,           \
                              (wxObject *)NULL),
#define EVT_PIPEDPROCESS_TERMINATED_RANGE(id, id1, fn)                                             \
    DECLARE_EVENT_TABLE_ENTRY(cbEVT_PIPEDPROCESS_TERMINATED, id, id1,                              \
                              (wxObjectEventFunction)(wxEventFunction)(wxCommandEventFunction)&fn, \
                              (wxObject *)NULL),

// thread-pool events
extern EVTIMPORT const wxEventType cbEVT_THREADTASK_STARTED;
#define EVT_THREADTASK_STARTED(id, fn)                                                             \
    DECLARE_EVENT_TABLE_ENTRY(cbEVT_THREADTASK_STARTED, id, wxID_ANY,                              \
                              (wxObjectEventFunction)(wxEventFunction)(wxCommandEventFunction)&fn, \
                              (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_THREADTASK_ENDED;
#define EVT_THREADTASK_ENDED(id, fn)                                                               \
    DECLARE_EVENT_TABLE_ENTRY(cbEVT_THREADTASK_ENDED, id, wxID_ANY,                                \
                              (wxObjectEventFunction)(wxEventFunction)(wxCommandEventFunction)&fn, \
                              (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_THREADTASK_ALLDONE;
#define EVT_THREADTASK_ALLDONE(id, fn)                                                             \
    DECLARE_EVENT_TABLE_ENTRY(cbEVT_THREADTASK_ALLDONE, id, wxID_ANY,                              \
                              (wxObjectEventFunction)(wxEventFunction)(wxCommandEventFunction)&fn, \
                              (wxObject *)NULL),

// request app to add and manage a docked window
extern EVTIMPORT const wxEventType cbEVT_ADD_DOCK_WINDOW;
#define EVT_ADD_DOCK_WINDOW(fn)                                                   \
    DECLARE_EVENT_TABLE_ENTRY(                                                    \
        cbEVT_ADD_DOCK_WINDOW, -1, -1,                                            \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksDockEventFunction)&fn, \
        (wxObject *)NULL),
// request app to stop managing a docked window
extern EVTIMPORT const wxEventType cbEVT_REMOVE_DOCK_WINDOW;
#define EVT_REMOVE_DOCK_WINDOW(fn)                                                \
    DECLARE_EVENT_TABLE_ENTRY(                                                    \
        cbEVT_REMOVE_DOCK_WINDOW, -1, -1,                                         \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksDockEventFunction)&fn, \
        (wxObject *)NULL),
// request app to show a docked window
extern EVTIMPORT const wxEventType cbEVT_SHOW_DOCK_WINDOW;
#define EVT_SHOW_DOCK_WINDOW(fn)                                                  \
    DECLARE_EVENT_TABLE_ENTRY(                                                    \
        cbEVT_SHOW_DOCK_WINDOW, -1, -1,                                           \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksDockEventFunction)&fn, \
        (wxObject *)NULL),
// request app to hide a docked window
extern EVTIMPORT const wxEventType cbEVT_HIDE_DOCK_WINDOW;
#define EVT_HIDE_DOCK_WINDOW(fn)                                                  \
    DECLARE_EVENT_TABLE_ENTRY(                                                    \
        cbEVT_HIDE_DOCK_WINDOW, -1, -1,                                           \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksDockEventFunction)&fn, \
        (wxObject *)NULL),
...
#define EVT_CBAUIBOOK_LEFT_DCLICK(winid, fn)                                                     \
    DECLARE_EVENT_TABLE_ENTRY(cbEVT_CBAUIBOOK_LEFT_DCLICK, winid, -1,                            \
                              (wxObjectEventFunction)(wxEventFunction)(wxMouseEventFunction)&fn, \
                              (wxObject *)NULL),
...
#define EVT_COMPLETE_CODE(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(       \
        cbEVT_COMPLETE_CODE, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
extern EVTIMPORT const wxEventType cbEVT_SHOW_CALL_TIP;
#define EVT_SHOW_CALL_TIP(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(       \
        cbEVT_SHOW_CALL_TIP, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),

// settings events

// event.GetInt() returns value of type cbSettingsType::Type indicating which setting group was
// changed
...
#define EVT_SETTINGS_CHANGED(fn)        \
    DECLARE_EVENT_TABLE_ENTRY(          \
        cbEVT_SETTINGS_CHANGED, -1, -1, \
        (wxObjectEventFunction)(wxEventFunction)(CodeBlocksEventFunction)&fn, (wxObject *)NULL),
