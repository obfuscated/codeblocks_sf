...
public:
     ...
     *  critical  - Something failed, and it hit you right in the eye. It really hurts, you have to
     * do something.
     *
     *  Other log levels are for special uses and may have side effects that you don't know about,
     *  and they may not work like expected under the specific conditions they run in... don't use
     * them.
     */
    enum level
    {
     ...
     *  It must be possible to call this function in presence and in absence of GUI without crashing
     * the application. It is not necessary to provide any actual output at all times, but it must
     * be 100% safe to call this function at all times. You may not throw from this function, it
     * must return in finite time, and it must not call logging functions (to prevent infinite
     * recursion). Other than that, you can do anything you want with the log messages that you
     * receive.
     */
