...
public:
    ...
    {
        cbThrow(_T("Can't assign an EditorBase* !!!"));
    }
...
protected:
     ...
     */
    virtual void AddToContextMenu(cb_optional wxMenu *popup, cb_optional ModuleType type,
     ...
     */
    virtual bool OnBeforeBuildContextMenu(cb_optional const wxPoint &position,
