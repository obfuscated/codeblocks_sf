...
public:
    ...
    virtual void GenerateCommandLine(wxString &macro, ProjectBuildTarget *target, ProjectFile *pf,
                                     const wxString &file, const wxString &object,
...
protected:
    virtual void DoBuildScripts(cbProject *project, CompileTargetBase *target,
                                const wxString &funcName);
    virtual wxString GetOrderedOptions(const ProjectBuildTarget *target, OptionsRelationType rel,
                                       const wxString &project_options,
                                       const wxString &target_options);
    virtual wxArrayString GetOrderedOptions(const ProjectBuildTarget *target,
    ...
    virtual wxArrayString GetOrderedResourceIncludeDirs(Compiler *compiler,
                                                        ProjectBuildTarget *target);
    static wxString MakeOptString(const wxArrayString &arr, const wxString &opt,
                                  wxChar separator = _T(' '));
    ...
    wxString m_PrjIncPath; ///< directive to add the project's top-level path in compiler search
                           ///< dirs (ready for the command line)
...
private:
    ...
    void SearchDirsFromBackticks(Compiler *compiler, ProjectBuildTarget *target,
