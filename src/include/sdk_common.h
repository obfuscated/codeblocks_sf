 ...
 * We might significantly reduce the compile time for old compilers, by undefining CB_PRECOMP and
 * thus not including every header file twice. This also allows us to reliably shortcut some
 * includes for compilers that *do* support precompilation.
 */
