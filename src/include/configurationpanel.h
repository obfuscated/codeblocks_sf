...
public:
    ...
    /// @return the panel's bitmap base name. You must supply two bitmaps: \<basename\>.png and
    /// \<basename\>-off.png...
    ...
    void SetParentDialog(wxWindow *dialog) { m_parentDialog = dialog; }
    ...
    int cbMessageBox(const wxString &message, const wxString &caption = wxEmptyString,
