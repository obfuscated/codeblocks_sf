...
public:
    ...
    /// @return true if compiler ID @c id inherits, directly or indirectly, from compiler ID @c
    /// from_id.
    ...
    static Compiler *SelectCompilerUI(const wxString &message = _("Select compiler"),
