 ...
 *
 * example:
 * ProjectLoaderHooks::HookFunctorBase* myhook = new ProjectLoaderHooks::HookFunctor<MyClass>(this,
 * &MyClass::OnHookCalled); int id = ProjectLoaderHooks::RegisterHook(myhook);
 * ...
