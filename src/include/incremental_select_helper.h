...
/// Class that implements a virtual list control that uses an IncrementalSelectIterator to populate
/// the list items.
class DLLIMPORT IncrementalListCtrl : public wxListCtrl
{
public:
    IncrementalListCtrl(wxWindow *parent, wxWindowID winid = wxID_ANY,
...
{
public:
    IncrementalSelectDialog(wxWindow *parent, IncrementalSelectIterator *iterator,
