...
public:
    ...
    /// This should return a string that when passed to the debugger will return the address of the
    /// variable. For example for C/C++ languages for myVar this function will return &myVar.
...
public:
    ...
    struct PluginData
    {
        ...
        {
            for (ConfigurationVector::iterator it = m_configurations.begin();
...
public:
    /** Called to register a debugger plugin. It is called by cbDebuggerPlugin::OnAttach and it
     * should not be called by the debugger plugins explicitly in their OnAttachReal methods. */
    bool RegisterDebugger(cbDebuggerPlugin *plugin);
    /** Called to unregister a debugger plugin. It is called by cbDebuggerPlugin::OnRelease and it
     * should not be called by the debugger plugins explicitly in their OnReleaseReal methods. */
