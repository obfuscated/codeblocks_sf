...
// this file contains some kinds of loggers, they can save/record messages to different kind of
// devices all these specific logger classes are derived from Logger class defined in logger.h
...
public:
    ListCtrlLogger(const wxArrayString &titles, const wxArrayInt &widths,
