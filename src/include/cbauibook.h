...
public:
     ...
     */
    cbAuiNotebook(wxWindow *pParent, wxWindowID id, const wxPoint &pos = wxDefaultPosition,
     ...
     * \param projectTitle only save the layout of the project with this title, save all projects
     * layout, if empty \return wxString the serialized layout
     */
     ...
     * \return true if successfull
     */
    bool AddPage(wxWindow *page, const wxString &caption, bool select = false,
     ...
     * \return true if successfull
     */
    bool InsertPage(size_t page_idx, wxWindow *page, const wxString &caption, bool select = false,
                    const wxBitmap &bitmap = wxNullBitmap);
