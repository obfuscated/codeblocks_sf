...
void CompilerGNUMSP430::Reset()
{
    ...
    m_Options.AddOption(_("MSP430 MSP1"), _T("-mcpu=msp1"), category);
    m_Options.AddOption(_("MSP430 MSP2"), _T("-mcpu=msp2"), category);
    m_Options.AddOption(_("MSP430 110"), _T("-mcpu=msp430x110"), category);
    m_Options.AddOption(_("MSP430 112"), _T("-mcpu=msp430x112"), category);
    m_Options.AddOption(_("MSP430 1101"), _T("-mcpu=msp430x1101"), category);
    m_Options.AddOption(_("MSP430 1111"), _T("-mcpu=msp430x1111"), category);
    m_Options.AddOption(_("MSP430 1121"), _T("-mcpu=msp430x1121"), category);
    m_Options.AddOption(_("MSP430 1122"), _T("-mcpu=msp430x1122"), category);
    m_Options.AddOption(_("MSP430 1132"), _T("-mcpu=msp430x1132"), category);
    m_Options.AddOption(_("MSP430 122"), _T("-mcpu=msp430x122"), category);
    m_Options.AddOption(_("MSP430 123"), _T("-mcpu=msp430x123"), category);
    m_Options.AddOption(_("MSP430 1222"), _T("-mcpu=msp430x1222"), category);
    m_Options.AddOption(_("MSP430 1232"), _T("-mcpu=msp430x1232"), category);
    m_Options.AddOption(_("MSP430 133"), _T("-mcpu=msp430x133"), category);
    m_Options.AddOption(_("MSP430 135"), _T("-mcpu=msp430x135"), category);
    m_Options.AddOption(_("MSP430 1331"), _T("-mcpu=msp430x1331"), category);
    m_Options.AddOption(_("MSP430 1351"), _T("-mcpu=msp430x1351"), category);
    m_Options.AddOption(_("MSP430 147"), _T("-mcpu=msp430x147"), category);
    m_Options.AddOption(_("MSP430 148"), _T("-mcpu=msp430x148"), category);
    m_Options.AddOption(_("MSP430 149"), _T("-mcpu=msp430x149"), category);
    m_Options.AddOption(_("MSP430 1471"), _T("-mcpu=msp430x1471"), category);
    m_Options.AddOption(_("MSP430 1481"), _T("-mcpu=msp430x1481"), category);
    m_Options.AddOption(_("MSP430 1491"), _T("-mcpu=msp430x1491"), category);
    m_Options.AddOption(_("MSP430 155"), _T("-mcpu=msp430x155"), category);
    m_Options.AddOption(_("MSP430 156"), _T("-mcpu=msp430x156"), category);
    m_Options.AddOption(_("MSP430 157"), _T("-mcpu=msp430x157"), category);
    m_Options.AddOption(_("MSP430 167"), _T("-mcpu=msp430x167"), category);
    m_Options.AddOption(_("MSP430 168"), _T("-mcpu=msp430x168"), category);
    m_Options.AddOption(_("MSP430 169"), _T("-mcpu=msp430x169"), category);
    m_Options.AddOption(_("MSP430 1610"), _T("-mcpu=msp430x1610"), category);
    m_Options.AddOption(_("MSP430 1611"), _T("-mcpu=msp430x1611"), category);
    m_Options.AddOption(_("MSP430 1612"), _T("-mcpu=msp430x1612"), category);
    m_Options.AddOption(_("MSP430 2001"), _T("-mcpu=msp430x2001"), category);
    m_Options.AddOption(_("MSP430 2011"), _T("-mcpu=msp430x2011"), category);
    m_Options.AddOption(_("MSP430 2002"), _T("-mcpu=msp430x2002"), category);
    m_Options.AddOption(_("MSP430 2012"), _T("-mcpu=msp430x2012"), category);
    m_Options.AddOption(_("MSP430 2003"), _T("-mcpu=msp430x2003"), category);
    m_Options.AddOption(_("MSP430 2013"), _T("-mcpu=msp430x2013"), category);
    m_Options.AddOption(_("MSP430 2101"), _T("-mcpu=msp430x2101"), category);
    m_Options.AddOption(_("MSP430 2111"), _T("-mcpu=msp430x2111"), category);
    m_Options.AddOption(_("MSP430 2121"), _T("-mcpu=msp430x2121"), category);
    m_Options.AddOption(_("MSP430 2131"), _T("-mcpu=msp430x2131"), category);
    m_Options.AddOption(_("MSP430 2234"), _T("-mcpu=msp430x2234"), category);
    m_Options.AddOption(_("MSP430 2254"), _T("-mcpu=msp430x2254"), category);
    m_Options.AddOption(_("MSP430 2274"), _T("-mcpu=msp430x2274"), category);
    m_Options.AddOption(_("MSP430 311"), _T("-mcpu=msp430x311"), category);
    m_Options.AddOption(_("MSP430 312"), _T("-mcpu=msp430x312"), category);
    m_Options.AddOption(_("MSP430 313"), _T("-mcpu=msp430x313"), category);
    m_Options.AddOption(_("MSP430 314"), _T("-mcpu=msp430x314"), category);
    m_Options.AddOption(_("MSP430 315"), _T("-mcpu=msp430x315"), category);
    m_Options.AddOption(_("MSP430 323"), _T("-mcpu=msp430x323"), category);
    m_Options.AddOption(_("MSP430 325"), _T("-mcpu=msp430x325"), category);
    m_Options.AddOption(_("MSP430 336"), _T("-mcpu=msp430x336"), category);
    m_Options.AddOption(_("MSP430 337"), _T("-mcpu=msp430x337"), category);
    m_Options.AddOption(_("MSP430 412"), _T("-mcpu=msp430x412"), category);
    m_Options.AddOption(_("MSP430 413"), _T("-mcpu=msp430x413"), category);
    m_Options.AddOption(_("MSP430 415"), _T("-mcpu=msp430x415"), category);
    m_Options.AddOption(_("MSP430 417"), _T("-mcpu=msp430x417"), category);
    m_Options.AddOption(_("MSP430 423"), _T("-mcpu=msp430x423"), category);
    m_Options.AddOption(_("MSP430 425"), _T("-mcpu=msp430x425"), category);
    m_Options.AddOption(_("MSP430 427"), _T("-mcpu=msp430x427"), category);
    m_Options.AddOption(_("MSP430 4250"), _T("-mcpu=msp430x4250"), category);
    m_Options.AddOption(_("MSP430 4260"), _T("-mcpu=msp430x4260"), category);
    m_Options.AddOption(_("MSP430 4270"), _T("-mcpu=msp430x4270"), category);
    m_Options.AddOption(_("MSP430 E423"), _T("-mcpu=msp430xE423"), category);
    m_Options.AddOption(_("MSP430 E425"), _T("-mcpu=msp430xE425"), category);
    m_Options.AddOption(_("MSP430 E427"), _T("-mcpu=msp430xE427"), category);
    m_Options.AddOption(_("MSP430 W423"), _T("-mcpu=msp430xW423"), category);
    m_Options.AddOption(_("MSP430 W425"), _T("-mcpu=msp430xW425"), category);
    m_Options.AddOption(_("MSP430 W427"), _T("-mcpu=msp430xW427"), category);
    m_Options.AddOption(_("MSP430 G437"), _T("-mcpu=msp430xG437"), category);
    m_Options.AddOption(_("MSP430 G438"), _T("-mcpu=msp430xG438"), category);
    m_Options.AddOption(_("MSP430 G439"), _T("-mcpu=msp430xG439"), category);
    m_Options.AddOption(_("MSP430 435"), _T("-mcpu=msp430x435"), category);
    m_Options.AddOption(_("MSP430 436"), _T("-mcpu=msp430x436"), category);
    m_Options.AddOption(_("MSP430 437"), _T("-mcpu=msp430x437"), category);
    m_Options.AddOption(_("MSP430 447"), _T("-mcpu=msp430x447"), category);
    m_Options.AddOption(_("MSP430 448"), _T("-mcpu=msp430x448"), category);
    m_Options.AddOption(_("MSP430 449"), _T("-mcpu=msp430x449"), category);
    m_Options.AddOption(_("MSP430 4616"), _T("-mcpu=msp430xG4616"), category);
    m_Options.AddOption(_("MSP430 4617"), _T("-mcpu=msp430xG4617"), category);
