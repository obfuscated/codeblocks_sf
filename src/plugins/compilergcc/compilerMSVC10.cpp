...
void CompilerMSVC10::Reset()
{
    ...
    m_Options.AddOption(_("enforce the new Standard C++ meaning for auto"), _T("/Zc:auto"), _("Language"));
    m_Options.AddOption(_("enable trigraphs (off by default)"), _T("/Zc:trigraphs"), _("Language"));
