...
wxDateTimePickerCtrl::wxDateTimePickerCtrl(void)
{

}

wxDateTimePickerCtrl::wxDateTimePickerCtrl(wxWindow *parent, wxWindowID id, wxString Format, const wxDateTime& dt, const wxPoint& pos, const wxSize& size, long style, const wxValidator& validator, const wxString& name)
{
    m_Format = Format;
...
WXDWORD wxDateTimePickerCtrl::MSWGetStyle(long style, WXDWORD *exstyle) const
{
...
// ----------------------------------------------------------------------------
// wxDateTimePickerCtrl geometry
// ----------------------------------------------------------------------------

wxSize wxDateTimePickerCtrl::DoGetBestSize() const
{
    wxClientDC dc(wx_const_cast(wxDateTimePickerCtrl *, this));
    dc.SetFont(GetFont());
    ...
    for ( int len = 100; ; len *= 2 )
    {
        if ( ::GetTimeFormat
               (
                    ...
                    _T("hh:mm:ss tt"),                   // no custom format
...
// ----------------------------------------------------------------------------
// wxDateTimePickerCtrl operations
// ----------------------------------------------------------------------------
...
wxDateTime wxDateTimePickerCtrl::GetValue() const
{
    ...
    wxASSERT_MSG( m_date.IsValid() == dt.IsValid() &&
                  ...
                  _T("bug in wxDateTimePickerCtrl: m_date not in sync") );
#endif // __WXDEBUG__

    return m_date;
}

void wxDateTimePickerCtrl::SetRange(const wxDateTime& dt1, const wxDateTime& dt2)
{
    SYSTEMTIME st[2];
...
bool wxDateTimePickerCtrl::GetRange(wxDateTime *dt1, wxDateTime *dt2) const
{
    SYSTEMTIME st[2];
