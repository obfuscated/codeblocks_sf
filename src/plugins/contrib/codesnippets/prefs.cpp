...
const CommonInfo g_CommonPrefs = {
    ...
    false,  // syntaxEnable //(pecan 2007/3/27)
    true,  // foldEnable
    true,  // indentEnable
    ...
    false,  // lineNumberEnable //(pecan 2007/3/27)
...
// keywordlists
// C++
wxChar* CppWordlist1 = wxT(""); //(pecan 2007/3/27)
/*
//wxChar* CppWordlist1 =
...
wxChar* CppWordlist2 = wxT(""); //(pecan 2007/3/27)
//wxChar* CppWordlist2 =
//    _T("file");

wxChar* CppWordlist3 = wxT(""); //(pecan 2007/3/27)
/*
//wxChar* CppWordlist3 =
...
const LanguageInfo g_LanguagePrefs [] = {
    // Remove syntax highlighting //(pecan 2007/3/27)
/*
//    // C++
//    {_T("C++"),
...
//const int g_LanguagePrefsSize = WXSIZEOF(g_LanguagePrefs); //(pecan 2007/3/27)
// Turn off syntax highlighting //(pecan 2007/3/27)
const int g_LanguagePrefsSize = 0;
