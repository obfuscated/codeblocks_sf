...
//-class DLLIMPORT cbConfigurationPanel : public wxPanel //(pecan 2019/03/1)
class cbConfigurationPanel : public wxPanel
{
    public:
        ...
        {
            if (parent)
                //-return ::cbMessageBox(message, caption, style, parent, x, y); //(pecan 2019/03/1)-
                return ::wxMessageBox(message, caption, style, parent, x, y);
            else
                //-return ::cbMessageBox(message, caption, style, m_parentDialog, x, y); //(pecan 2019/03/1)
                return ::wxMessageBox(message, caption, style, m_parentDialog, x, y);
        }
    private:
...
//-class DLLIMPORT cbConfigurationDialog : public wxScrollingDialog //(pecan 2019/03/1)-
class cbConfigurationDialog : public wxDialog
{
    public:
