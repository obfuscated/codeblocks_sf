...
md ..\..\..\devel30\share\CodeBlocks\images\ThreadSearch\32x32 > nul 2>&1
md ..\..\..\output30\share\CodeBlocks\images\ThreadSearch\32x32 > nul 2>&1
...
copy .\resources\images\32x32\*.png ..\..\..\devel30\share\CodeBlocks\images\ThreadSearch\32x32\ > nul 2>&1
...
copy .\resources\images\32x32\*.png ..\..\..\output30\share\CodeBlocks\images\ThreadSearch\32x32\ > nul 2>&1
