...
md ..\..\..\devel31\share\CodeBlocks\images\ThreadSearch\32x32 > nul 2>&1
md ..\..\..\output31\share\CodeBlocks\images\ThreadSearch\32x32 > nul 2>&1
...
copy .\resources\images\32x32\*.png ..\..\..\devel31\share\CodeBlocks\images\ThreadSearch\32x32\ > nul 2>&1
...
copy .\resources\images\32x32\*.png ..\..\..\output31\share\CodeBlocks\images\ThreadSearch\32x32\ > nul 2>&1
