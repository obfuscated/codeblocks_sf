...
wxsSettings::wxsSettings(wxWindow* parent,wxWindowID id)
{
	...
	m_DragAssistType->SetSelection( m_DragAssistType->Append(_("None")) );
	...
	FlexGridSizer2->Add(m_GridSize, 1, wxALL|wxEXPAND|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	StaticText1 = new wxStaticText(this, ID_STATICTEXT1, _("Add new items continously:"), wxDefaultPosition, wxDefaultSize, wxALIGN_CENTRE, _T("ID_STATICTEXT1"));
