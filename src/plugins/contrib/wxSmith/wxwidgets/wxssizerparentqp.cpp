    ...
    m_Extra(Extra)
{
    ...
    GridSizer1->Add(BrdAll, 0, wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 0);
    ...
    StaticBoxSizer3->Add(Proportion, 0, wxTOP|wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
