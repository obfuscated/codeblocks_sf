...
wxsImageListEditorDlg::wxsImageListEditorDlg(wxWindow *parent, wxWindowID id, const wxPoint &pos, const wxSize &size)
{
    ...
    BoxSizer2->Add(StaticText14, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    ...
    BoxSizer2->Add(StaticText15, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    StaticText16 = new wxStaticText(this, ID_STATICTEXT16, _("Image Count"), wxPoint(144,20), wxSize(-1,18), 0, _T("ID_STATICTEXT16"));
    BoxSizer2->Add(StaticText16, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    ...
    BoxSizer2->Add(StaticText17, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    StaticText18 = new wxStaticText(this, ID_STATICTEXT18, _("Image Size"), wxPoint(248,20), wxSize(-1,18), 0, _T("ID_STATICTEXT18"));
    BoxSizer2->Add(StaticText18, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    ...
    BoxSizer2->Add(StaticText26, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    StaticText19 = new wxStaticText(this, ID_STATICTEXT19, _("x"), wxPoint(344,20), wxSize(-1,18), 0, _T("ID_STATICTEXT19"));
    BoxSizer2->Add(StaticText19, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    ...
    BoxSizer2->Add(StaticText27, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    StaticBoxSizer2->Add(BoxSizer2, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    ...
    bLeft->SetDefault();
    BoxSizer6->Add(bLeft, 0, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 0);
    BoxSizer5->Add(BoxSizer6, 0, wxLEFT|wxRIGHT|wxALIGN_LEFT|wxALIGN_TOP, 5);
    ...
    BoxSizer7->Add(Panel2, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer7->Add(StaticText2, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    BoxSizer5->Add(BoxSizer7, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer8->Add(Panel3, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer8->Add(StaticText3, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    BoxSizer5->Add(BoxSizer8, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer9->Add(Panel4, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer9->Add(StaticText4, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    BoxSizer5->Add(BoxSizer9, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer10->Add(Panel5, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer10->Add(StaticText5, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    BoxSizer5->Add(BoxSizer10, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer11->Add(Panel8, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer11->Add(StaticText6, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    BoxSizer5->Add(BoxSizer11, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer12->Add(Panel6, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer12->Add(StaticText7, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    BoxSizer5->Add(BoxSizer12, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer13->Add(Panel7, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer13->Add(StaticText8, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    BoxSizer5->Add(BoxSizer13, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer14->Add(Panel9, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer14->Add(StaticText9, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    BoxSizer5->Add(BoxSizer14, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer15->Add(Panel10, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer15->Add(StaticText10, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    BoxSizer5->Add(BoxSizer15, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer16->Add(Panel11, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer16->Add(StaticText12, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    BoxSizer5->Add(BoxSizer16, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    bRight->SetDefault();
    BoxSizer17->Add(bRight, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    BoxSizer5->Add(BoxSizer17, 0, wxLEFT|wxRIGHT|wxALIGN_LEFT|wxALIGN_TOP, 5);
    StaticBoxSizer2->Add(BoxSizer5, 1, wxALL|wxALIGN_BOTTOM|wxALIGN_CENTER_HORIZONTAL, 5);
    BoxSizer1->Add(StaticBoxSizer2, 0, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    ...
    BoxSizer20->Add(StaticText1, 1, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    BoxSizer18->Add(BoxSizer20, 0, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer21->Add(Panel1, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    BoxSizer18->Add(BoxSizer21, 0, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer22->Add(StaticText23, 1, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    BoxSizer18->Add(BoxSizer22, 0, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    StaticBoxSizer1->Add(BoxSizer18, 0, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    ...
    bRead->SetDefault();
    BoxSizer23->Add(bRead, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer19->Add(BoxSizer23, 0, wxTOP|wxBOTTOM|wxEXPAND|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    ...
    BoxSizer24->Add(cxTransparent, 0, wxLEFT|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 14);
    BoxSizer19->Add(BoxSizer24, 0, wxTOP|wxBOTTOM|wxEXPAND|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    BoxSizer25 = new wxBoxSizer(wxHORIZONTAL);
    bColor = new wxButton(this, ID_BUTTON2, _("C"), wxPoint(104,192), wxSize(32,32), 0, wxDefaultValidator, _T("ID_BUTTON2"));
    wxFont bColorFont(10,wxSWISS,wxFONTSTYLE_ITALIC,wxBOLD,false,_T("Sans"),wxFONTENCODING_DEFAULT);
    bColor->SetFont(bColorFont);
    BoxSizer25->Add(bColor, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    StaticText21 = new wxStaticText(this, ID_STATICTEXT21, _("Mask Color"), wxPoint(136,200), wxDefaultSize, 0, _T("ID_STATICTEXT21"));
    BoxSizer25->Add(StaticText21, 0, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    BoxSizer19->Add(BoxSizer25, 0, wxTOP|wxBOTTOM|wxEXPAND|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    ...
    BoxSizer26->Add(bAdd, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    StaticText11 = new wxStaticText(this, ID_STATICTEXT13, _("Add To List"), wxPoint(136,224), wxDefaultSize, 0, _T("ID_STATICTEXT13"));
    BoxSizer26->Add(StaticText11, 0, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    BoxSizer19->Add(BoxSizer26, 0, wxTOP|wxBOTTOM|wxEXPAND|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    StaticBoxSizer1->Add(BoxSizer19, 0, wxTOP|wxBOTTOM|wxEXPAND|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    BoxSizer3->Add(StaticBoxSizer1, 0, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    ...
    BoxSizer29->Add(StaticText22, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    BoxSizer27->Add(BoxSizer29, 0, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer30->Add(Panel12, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    BoxSizer27->Add(BoxSizer30, 0, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    ...
    BoxSizer31->Add(StaticText28, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    BoxSizer27->Add(BoxSizer31, 0, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    StaticBoxSizer3->Add(BoxSizer27, 0, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    ...
    bDel->SetDefault();
    BoxSizer32->Add(bDel, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    StaticText13 = new wxStaticText(this, ID_STATICTEXT14, _("Delete Image"), wxPoint(336,148), wxDefaultSize, 0, _T("ID_STATICTEXT14"));
    BoxSizer32->Add(StaticText13, 0, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    BoxSizer28->Add(BoxSizer32, 0, wxTOP|wxBOTTOM|wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    ...
    bClear->SetDefault();
    BoxSizer33->Add(bClear, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    StaticText24 = new wxStaticText(this, ID_STATICTEXT24, _("Clear List"), wxPoint(336,178), wxDefaultSize, 0, _T("ID_STATICTEXT24"));
    BoxSizer33->Add(StaticText24, 0, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    BoxSizer28->Add(BoxSizer33, 0, wxTOP|wxBOTTOM|wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    ...
    bSave->SetDefault();
    BoxSizer34->Add(bSave, 0, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 0);
    StaticText25 = new wxStaticText(this, ID_STATICTEXT25, _("Export BMP"), wxPoint(336,208), wxDefaultSize, 0, _T("ID_STATICTEXT25"));
    BoxSizer34->Add(StaticText25, 0, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    BoxSizer28->Add(BoxSizer34, 0, wxTOP|wxBOTTOM|wxEXPAND|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
    StaticBoxSizer3->Add(BoxSizer28, 0, wxTOP|wxBOTTOM|wxEXPAND|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    BoxSizer3->Add(StaticBoxSizer3, 0, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    BoxSizer1->Add(BoxSizer3, 0, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_BOTTOM, wxDLG_UNIT(this,wxSize(5,0)).GetWidth());
    ...
    BoxSizer4->Add(-1,-1,1, wxALL|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    ...
    BoxSizer1->Add(BoxSizer4, 0, wxALL|wxEXPAND|wxALIGN_LEFT|wxALIGN_BOTTOM, 5);
    SetSizer(BoxSizer1);
