...
void AstyleConfigDlg::LoadSettings()
{
    ...
    XRCCTRL(*this, "spnIndentation", wxSpinCtrl)->SetValue(ConfigManager::Get()->Read("/astyle/indentation", 4));
    XRCCTRL(*this, "chkUseTab", wxCheckBox)->SetValue(ConfigManager::Get()->Read("/astyle/use_tabs", 0L));
    XRCCTRL(*this, "chkForceUseTabs", wxCheckBox)->SetValue(ConfigManager::Get()->Read("/astyle/force_tabs", 0L));
    XRCCTRL(*this, "chkConvertTabs", wxCheckBox)->SetValue(ConfigManager::Get()->Read("/astyle/convert_tabs", 0L));
    XRCCTRL(*this, "chkFillEmptyLines", wxCheckBox)->SetValue(ConfigManager::Get()->Read("/astyle/fill_empty_lines", 0L));
    XRCCTRL(*this, "chkIndentClasses", wxCheckBox)->SetValue(ConfigManager::Get()->Read("/astyle/indent_classes", 0L));
    XRCCTRL(*this, "chkIndentSwitches", wxCheckBox)->SetValue(ConfigManager::Get()->Read("/astyle/indent_switches", 0L));
    XRCCTRL(*this, "chkIndentCase", wxCheckBox)->SetValue(ConfigManager::Get()->Read("/astyle/indent_case", 0L));
    XRCCTRL(*this, "chkIndentBrackets", wxCheckBox)->SetValue(ConfigManager::Get()->Read("/astyle/indent_brackets", 0L));
    XRCCTRL(*this, "chkIndentBlocks", wxCheckBox)->SetValue(ConfigManager::Get()->Read("/astyle/indent_blocks", 0L));
    ...
    XRCCTRL(*this, "chkPadParens", wxCheckBox)->SetValue(ConfigManager::Get()->Read("/astyle/pad_parentheses", 0L));
    XRCCTRL(*this, "chkKeepComplex", wxCheckBox)->SetValue(ConfigManager::Get()->Read("/astyle/keep_complex", 0L));
    XRCCTRL(*this, "chkKeepBlocks", wxCheckBox)->SetValue(ConfigManager::Get()->Read("/astyle/keep_blocks", 0L));
...
void AstyleConfigDlg::SaveSettings()
{
    ...
    if (XRCCTRL(*this, "rbAnsi", wxRadioButton)->GetValue())
        ...
        style = 5;
    ConfigManager::Get()->Write("/astyle/style", style);
    ConfigManager::Get()->Write("/astyle/indentation", XRCCTRL(*this, "spnIndentation", wxSpinCtrl)->GetValue());
    ConfigManager::Get()->Write("/astyle/use_tabs", XRCCTRL(*this, "chkUseTab", wxCheckBox)->GetValue());
    ConfigManager::Get()->Write("/astyle/force_tabs", XRCCTRL(*this, "chkForceUseTabs", wxCheckBox)->GetValue());
    ConfigManager::Get()->Write("/astyle/convert_tabs", XRCCTRL(*this, "chkConvertTabs", wxCheckBox)->GetValue());
    ConfigManager::Get()->Write("/astyle/fill_empty_lines", XRCCTRL(*this, "chkFillEmptyLines", wxCheckBox)->GetValue());
    ConfigManager::Get()->Write("/astyle/indent_classes", XRCCTRL(*this, "chkIndentClasses", wxCheckBox)->GetValue());
    ConfigManager::Get()->Write("/astyle/indent_switches", XRCCTRL(*this, "chkIndentSwitches", wxCheckBox)->GetValue());
    ConfigManager::Get()->Write("/astyle/indent_case", XRCCTRL(*this, "chkIndentCase", wxCheckBox)->GetValue());
    ConfigManager::Get()->Write("/astyle/indent_brackets", XRCCTRL(*this, "chkIndentBrackets", wxCheckBox)->GetValue());
    ConfigManager::Get()->Write("/astyle/indent_blocks", XRCCTRL(*this, "chkIndentBlocks", wxCheckBox)->GetValue());
    ...
    ConfigManager::Get()->Write("/astyle/pad_parentheses", XRCCTRL(*this, "chkPadParens", wxCheckBox)->GetValue());
    ConfigManager::Get()->Write("/astyle/keep_complex", XRCCTRL(*this, "chkKeepComplex", wxCheckBox)->GetValue());
    ConfigManager::Get()->Write("/astyle/keep_blocks", XRCCTRL(*this, "chkKeepBlocks", wxCheckBox)->GetValue());
}
