...
CompilerPanel::CompilerPanel(wxWindow* parent,wxWindowID id)
{
	...
	StaticText1 = new wxStaticText(this,ID_STATICTEXT1,_("Please select the compiler to use and which configurations\nyou want enabled in your project."),wxDefaultPosition,wxDefaultSize,0);
	StaticText2 = new wxStaticText(this,ID_STATICTEXT2,_("Compiler:"),wxDefaultPosition,wxDefaultSize,0);
	cmbCompiler = new wxComboBox(this,ID_COMBOBOX1,_T(""),wxDefaultPosition,wxDefaultSize,0,NULL,wxCB_SIMPLE|wxCB_READONLY);
	BoxSizer4 = new wxBoxSizer(wxHORIZONTAL);
	chkConfDebug = new wxCheckBox(this,ID_CHECKBOX1,_("Create \"Debug\" configuration:"),wxDefaultPosition,wxDefaultSize,0);
	chkConfDebug->SetValue(true);
	txtDbgName = new wxTextCtrl(this,ID_TEXTCTRL3,_T(""),wxDefaultPosition,wxDefaultSize,0);
	...
	StaticText3 = new wxStaticText(this,ID_STATICTEXT3,_("Output dir.:"),wxDefaultPosition,wxDefaultSize,0);
	txtDbgOut = new wxTextCtrl(this,ID_TEXTCTRL1,_T(""),wxDefaultPosition,wxDefaultSize,0);
	if ( 0 ) txtDbgOut->SetMaxLength(0);
	StaticText4 = new wxStaticText(this,ID_STATICTEXT4,_("Objects output dir.:"),wxDefaultPosition,wxDefaultSize,0);
	txtDbgObjOut = new wxTextCtrl(this,ID_TEXTCTRL2,_T(""),wxDefaultPosition,wxDefaultSize,0);
	...
	chkConfRelease = new wxCheckBox(this,ID_CHECKBOX3,_("Create \"Release\" configuration:"),wxDefaultPosition,wxDefaultSize,0);
	chkConfRelease->SetValue(true);
	txtRelName = new wxTextCtrl(this,ID_TEXTCTRL4,_T(""),wxDefaultPosition,wxDefaultSize,0);
	...
	StaticText7 = new wxStaticText(this,ID_STATICTEXT7,_("Output dir.:"),wxDefaultPosition,wxDefaultSize,0);
	txtRelOut = new wxTextCtrl(this,ID_TEXTCTRL5,_T(""),wxDefaultPosition,wxDefaultSize,0);
	if ( 0 ) txtRelOut->SetMaxLength(0);
	StaticText8 = new wxStaticText(this,ID_STATICTEXT8,_("Objects output dir.:"),wxDefaultPosition,wxDefaultSize,0);
	txtRelObjOut = new wxTextCtrl(this,ID_TEXTCTRL6,_T(""),wxDefaultPosition,wxDefaultSize,0);
