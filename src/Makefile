...
GLOBAL_LDFLAGS= 
PROJECT_LDFLAGS= -lwxmsw242 -lgmon 
GLOBAL_INCS= -IE:/DevCode/wxWindows-2.4.2/include -IE:/DevCode/wxWindows-2.4.2/contrib/include -IE:/Programs/Mingw/include
PROJECT_INCS=
GLOBAL_LIBS= -LE:/DevCode/wxWindows-2.4.2/lib -LE:/DevCode/wxWindows-2.4.2/contrib/lib -LE:/STLport-4.6/lib -LE:/Programs/Mingw/lib
...
plugin_CompilerGCC_LDFLAGS= $(GLOBAL_LDFLAGS) -Wl,--enable-auto-image-base -Wl,--add-stdcall-alias -lcodeblocks -lstc -lwxxrc -lwxmsw242 
plugin_DebuggerGDB_LDFLAGS= $(GLOBAL_LDFLAGS) -Wl,--enable-auto-image-base -Wl,--add-stdcall-alias -lcodeblocks -lstc -lwxxrc -lwxmsw242 
plugin_CodeCompletion_LDFLAGS= $(GLOBAL_LDFLAGS) -Wl,--enable-auto-image-base -Wl,--add-stdcall-alias -lcodeblocks -lstc -lwxxrc -lwxmsw242 
plugin_ClassWizard_LDFLAGS= $(GLOBAL_LDFLAGS) -Wl,--enable-auto-image-base -Wl,--add-stdcall-alias -lcodeblocks -lstc -lwxxrc -lwxmsw242 
plugin_PluginsWizard_LDFLAGS= $(GLOBAL_LDFLAGS) -Wl,--enable-auto-image-base -Wl,--add-stdcall-alias -lcodeblocks -lstc -lwxxrc -lwxmsw242 
plugin_ToDo_LDFLAGS= $(GLOBAL_LDFLAGS) $(PROJECT_LDFLAGS) -Wl,--enable-auto-image-base -Wl,--add-stdcall-alias -lcodeblocks -lwxmsw242 
plugin_XPManifest_LDFLAGS= $(GLOBAL_LDFLAGS) $(PROJECT_LDFLAGS) -Wl,--enable-auto-image-base -Wl,--add-stdcall-alias -lcodeblocks -lwxmsw242 
...
$(src_RESOURCE): src/resources/resources.rc 
	$(RESCOMP) -i src_private.rc -I rc -o $(src_RESOURCE) -O coff  --include-dir=E:/DevCode/wxWindows-2.4.2/include --include-dir=E:/DevCode/wxWindows-2.4.2/contrib/include --include-dir=E:/Programs/Mingw/include --include-dir=sdk
