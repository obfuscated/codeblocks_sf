...
# Project:          Code::Blocks
# Project filename: E:\MyProjects\CodeBlocks\codeblocks\src\CodeBlocks.cbp
# Date:             06/11/04 06:17:51
...
GLOBAL_CFLAGS= 
PROJECT_CFLAGS= -ggdb -pipe -mthreads -fno-pcc-struct-return -fno-rtti -fmessage-length=0 -D__GNUWIN32__ -D__WXMSW__ -DWXUSINGDLL
GLOBAL_LDFLAGS= 
PROJECT_LDFLAGS= -lwxmsw$(WX_VER) -lgmon
GLOBAL_INCS= -IE:/Programs/MinGW/include -IE:/DevCode/wxWindows-2.4.2/include -IE:/DevCode/wxWindows-2.4.2/contrib/include
PROJECT_INCS= -IE:/DevCode/wxWindows-2.4.2/lib/mswdll
GLOBAL_LIBS= -LE:/Programs/MinGW/lib -LE:/DevCode/wxWindows-2.4.2/lib -LE:/DevCode/wxWindows-2.4.2/contrib/lib
...
$(src_RESOURCE): src/resources/resources.rc 
	$(RESCOMP) -i src_private.rc -J rc -o $(src_RESOURCE) -O coff  --include-dir=E:/Programs/MinGW/include --include-dir=E:/DevCode/wxWindows-2.4.2/include --include-dir=E:/DevCode/wxWindows-2.4.2/contrib/include --include-dir=sdk
