...
$(sdk_BIN): $(sdk_LINKOBJS)
	...
	@$(LD) -shared   -Wl,--dll $(sdk_LIBS) $(sdk_LINKOBJS) $(sdk_LDADD) -o $(sdk_BIN) $(sdk_LDFLAGS)
...
sdk/Managers/Managers.d: sdk/Managers/Managers.cpp
	@echo Calculating dependencies for "sdk\Managers\Managers.cpp"...
	@$(CPP) -MM $(sdk_CFLAGS) -MF sdk/Managers/Managers.d -MT sdk/Managers/Managers.o $(sdk_INCS) sdk/Managers/Managers.cpp

sdk/Managers/Managers.o: sdk/Managers/Managers.d
	@echo Compiling "sdk\Managers\Managers.cpp"...
	@$(CPP) $(sdk_CFLAGS) $(sdk_INCS) -c sdk/Managers/Managers.cpp -o sdk/Managers/Managers.o

sdk/Managers/StdAfx.d: sdk/Managers/StdAfx.cpp
	@echo Calculating dependencies for "sdk\Managers\StdAfx.cpp"...
	@$(CPP) -MM $(sdk_CFLAGS) -MF sdk/Managers/StdAfx.d -MT sdk/Managers/StdAfx.o $(sdk_INCS) sdk/Managers/StdAfx.cpp

sdk/Managers/StdAfx.o: sdk/Managers/StdAfx.d
...
sdk/devcpploader.d: sdk/devcpploader.cpp
	@echo Calculating dependencies for "sdk\devcpploader.cpp"...
	@$(CPP) -MM $(sdk_CFLAGS) -MF sdk/devcpploader.d -MT sdk/devcpploader.o $(sdk_INCS) sdk/devcpploader.cpp

sdk/devcpploader.o: sdk/devcpploader.d
...
sdk/msvcloader.d: sdk/msvcloader.cpp
	@echo Calculating dependencies for "sdk\msvcloader.cpp"...
	@$(CPP) -MM $(sdk_CFLAGS) -MF sdk/msvcloader.d -MT sdk/msvcloader.o $(sdk_INCS) sdk/msvcloader.cpp

sdk/msvcloader.o: sdk/msvcloader.d
