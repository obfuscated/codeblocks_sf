...
public:
    ...
    wxSwitcherItem &AddItem(const wxString &title, const wxString &name, int id = 0,
                            const wxBitmap &bitmap = wxNullBitmap);
    wxSwitcherItem &AddItem(const wxString &title, const wxString &name, const wxString &descr,
                            int id = 0, const wxBitmap &bitmap = wxNullBitmap);
    wxSwitcherItem &AddItem(const wxSwitcherItem &item);
    wxSwitcherItem &AddGroup(const wxString &title, const wxString &name, int id = 0,
                             const wxBitmap &bitmap = wxNullBitmap);
...
public:
    wxMultiColumnListCtrl(wxWindow *parent, wxWindowID id, const wxPoint &pos = wxDefaultPosition,
...
public:
    ...
    wxSwitcherDialog(const wxSwitcherItems &items, wxWindow *parent, wxWindowID id = -1,
                     const wxString &title = _("Pane Switcher"),
                     const wxPoint &pos = wxDefaultPosition, const wxSize &size = wxDefaultSize,
                     long style = wxSTAY_ON_TOP | wxDIALOG_NO_PARENT | wxBORDER_SIMPLE);

    bool Create(const wxSwitcherItems &items, wxWindow *parent, wxWindowID id = -1,
                const wxString &title = _("Pane Switcher"), const wxPoint &pos = wxDefaultPosition,
