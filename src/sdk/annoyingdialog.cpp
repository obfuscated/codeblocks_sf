...
AnnoyingDialog::AnnoyingDialog(const wxString &caption, const wxString &message, const wxArtID icon,
                               dStyle style, dReturnType defaultReturn, const wxString &b1,
                               const wxString &b2, const wxString &b3)
...
void AnnoyingDialog::Init(const wxString &caption, const wxString &id, const wxString &message,
                          const wxArtID icon, dStyle style, const wxString &b1, const wxString &b2,
                          const wxString &b3)
{
    m_CheckBox = nullptr;
    m_DontAnnoy = false;
    ...
    wxStaticBitmap *bitmap = new wxStaticBitmap(
        this, -1, wxArtProvider::GetBitmap(icon, wxART_MESSAGE_BOX), wxDefaultPosition);
    ...
    if (style < ONE_BUTTON) // standard buttons? use wxStdDialogButtonSizer
    {
        ...
        wxButton *but1 = new wxButton(this, id1 == rtYES ? wxID_YES : wxID_OK, bTxt1,
        ...
        if (numButtons > 1)
        {
            wxButton *but2 = new wxButton(this, id2 == rtNO ? wxID_NO : wxID_CANCEL, bTxt2,
                                          wxDefaultPosition, wxDefaultSize, 0);
            if (id2 == m_DefRet)
                but2->SetDefault();
        ...
        {
            wxButton *but3 =
                new wxButton(this, wxID_CANCEL, bTxt3, wxDefaultPosition, wxDefaultSize, 0);
            if (id3 == m_DefRet)
                but3->SetDefault();
    ...
    m_CheckBox = new wxCheckBox(this, wxID_ANY, _("Don't annoy me again!"), wxDefaultPosition,
                                wxDefaultSize, 0);
