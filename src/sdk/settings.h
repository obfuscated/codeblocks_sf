...
#define MSVC_FILES_FILTER           "Microsoft Visual C++ project files (*.dsp)|*.dsp"
#define MSVS_FILES_FILTER           "Microsoft Visual Studio project files (*.vcproj)|*.vcproj"
#define MSVC_WORKSPACE_FILES_FILTER "Microsoft Visual C++ workspace/project files (*.dsw;*.dsp)|*.dsw;*.dsp"
#define MSVS_WORKSPACE_FILES_FILTER "Microsoft Visual Studio solution/project files (*.sln;*.vcproj)|*.sln;*.vcproj"
