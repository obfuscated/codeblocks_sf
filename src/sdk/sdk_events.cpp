...
DEFINE_CB_EVENT_TYPE(cbEVT_EDITOR_BREAKPOINT_ADDED)
DEFINE_CB_EVENT_TYPE(cbEVT_EDITOR_BREAKPOINT_DELETED)
...
DEFINE_CB_EVENT_TYPE(cbEVT_DOCK_WINDOW)
DEFINE_CB_EVENT_TYPE(cbEVT_UNDOCK_WINDOW)
