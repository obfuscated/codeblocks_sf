...
SQInteger EditArrayFileDlg_Ctor(HSQUIRRELVM v)
{
    ...
    {
        dlg = new EditArrayFileDlg(nullptr, *SqPlus::GetInstance<wxArrayString, false>(v, 2),
                                   sa.GetBool(3), *SqPlus::GetInstance<wxString, false>(v, 4));
    }
...
SQInteger EditPairDlg_Ctor(HSQUIRRELVM v)
{
    ...
    {
        dlg = new EditPairDlg(nullptr, *SqPlus::GetInstance<wxString, false>(v, 2),
...
SQInteger EditPathDlg_Ctor(HSQUIRRELVM v)
{
    ...
    {
        dlg = new EditPathDlg(nullptr, *SqPlus::GetInstance<wxString, false>(v, 2),
                              *SqPlus::GetInstance<wxString, false>(v, 3),
                              *SqPlus::GetInstance<wxString, false>(v, 4),
                              *SqPlus::GetInstance<wxString, false>(v, 5), sa.GetBool(6),
                              sa.GetBool(7), *SqPlus::GetInstance<wxString, false>(v, 8));
    }
...
SQInteger GenericMultiLineNotesDlg_Ctor(HSQUIRRELVM v)
{
    ...
    if (sa.GetParamCount() > 3)
    {
        dlg = new GenericMultiLineNotesDlg(nullptr, *SqPlus::GetInstance<wxString, false>(v, 2),
                                           *SqPlus::GetInstance<wxString, false>(v, 3),
                                           sa.GetBool(4));
    }
    else if (sa.GetParamCount() > 2)
