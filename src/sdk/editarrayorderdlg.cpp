...
{
    wxXmlResource::Get()->LoadObject(this, parent, _T("dlgEditArrayOrder"),
...
void EditArrayOrderDlg::OnUpdateUI(wxUpdateUIEvent &WXUNUSED(event))
{
    ...
    XRCCTRL(*this, "btnMoveDown", wxButton)
        ->Enable(list->GetSelection() >= 0 && list->GetSelection() < (int)list->GetCount() - 1);
}
