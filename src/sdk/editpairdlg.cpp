...
EditPairDlg::EditPairDlg(wxWindow *parent, wxString &key, wxString &value, const wxString &title,
                         BrowseMode allowBrowse)
  : m_Key(key), m_Value(value), m_BrowseMode(allowBrowse)
{
    // ctor
...
void EditPairDlg::OnBrowse(cb_unused wxCommandEvent &event)
{
    switch (m_BrowseMode)
    {
        ...
        {
            wxFileDialog dlg(
                this, _("Select file"), XRCCTRL(*this, "txtValue", wxTextCtrl)->GetValue(), _T(""),
        ...
        {
            wxString dir = ChooseDirectory(this, _("Select directory"),
