...
wxString wxScintilla::GetTag(int tagNumber)
{
    long msg = SCI_GETTAG;
    long len = SendMsg(msg, tagNumber, 0);
...
{
    long msg = SCI_ANNOTATIONGETTEXT;
    long len = SendMsg(msg, line, 0);
...
{
    long msg = SCI_ANNOTATIONGETSTYLES;
    long len = SendMsg(msg, line, 0);
