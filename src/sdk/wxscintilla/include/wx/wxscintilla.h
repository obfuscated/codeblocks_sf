...
DECLARE_EXPORTED_EVENT_TYPE (WXDLLIMPEXP_SCI, wxEVT_SCI_AUTOCOMP_SELECTION_CHANGE, 1685);
END_DECLARE_EVENT_TYPES()
    ...
    enum {
        ...
        wxEVT_SCI_AUTOCOMP_SELECTION_CHANGE
    };
#endif
...
#define EVT_SCI_AUTOCOMP_SELECTION_CHANGE(id, fn)    DECLARE_EVENT_TABLE_ENTRY( wxEVT_SCI_AUTOCOMP_SELECTION_CHANGE,    id, wxID_ANY, wxScintillaEventHandler( fn ), (wxObject *) NULL ),
#endif
