...
BrowseTracker is a plugin that helps navigating between recently opened files in \codeblocks. The list of recent files is saved in a history. With the menu \menu{View,Browse Tracker,Clear All} the history is cleared.
...
The settings of the plugin can be configure via the menu \menu{View,Browse Tracker,Settings}.
