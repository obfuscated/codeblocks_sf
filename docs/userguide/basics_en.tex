...
A lot of typing can be saved in \codeblocks by defining abbreviation. This is done by selecting \menu{Settings,Editor} and defining the abbreviations under the name \var{name}, which can then be called by the keyboard shortcut Ctrl-J. Parametrisation is also possible by including variables \codeline{$(NAME}) in the abbreviations.
...
\screenshot{select_function}{Search for functions}
